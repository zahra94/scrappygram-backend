...
class Notification extends App {
    ...
    public static function ticketUser($ticketid,$reply,$templateid) { //send ticket notification
    	...
    	$search = array('{ticketid}', '{status}', '{subject}', '{contact}', '{message}', '{company}');
    	$replace = array($ticket['ticket'], $ticket['status'], $ticket['subject'], $contact, $reply, getConfigValue("company_name"));
    ...
    public static function ticketStaff($ticketid,$reply,$templateid) { //send ticket notification
    	...
    	$search = array('{ticketid}', '{status}', '{subject}', '{message}', '{company}');
    	$replace = array($ticket['ticket'], $ticket['status'], $ticket['subject'], $reply, getConfigValue("company_name"));
