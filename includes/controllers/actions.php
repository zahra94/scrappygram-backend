...
switch($_POST['action']) {
	...
	case "addCustomer":
		...
		$status = Customer::add($_POST);
		break;

	case "editCustomer":
		// isAuthorized("editCustomer"); 
		$status = Customer::edit($_POST);
		break;

	case "deleteCustomer":
		// isAuthorized("deleteCustomer"); 
		$status = Customer::delete($_POST['id']);
		break;

	// Vendors
	case "addVendor":
		// isAuthorized("addUser"); 
		$status = Vendor::add($_POST);
		break;

	case "editVendor":
		// isAuthorized("editCustomer"); 
		$status = Vendor::edit($_POST);
		break;
